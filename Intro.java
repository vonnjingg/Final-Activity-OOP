...
public class Intro {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 480, 630);
		...
		lbl_Logo.setBounds(10, 11, 133, 119);
		...
		Image modifiedLogo = logoImg.getScaledInstance(125, 125, java.awt.Image.SCALE_SMOOTH);
		...
		btn_Register.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {
				btn_Register.setBounds(10, 500, 104, 63);
				btn_login.setBounds(178, 500, 104, 23);
				btn_Exit.setBounds(350, 500, 104, 23);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btn_Register.setBounds(10, 500, 104, 43);
				btn_login.setBounds(178, 500, 104, 43);
				btn_Exit.setBounds(350, 500, 104, 43);
			}
		});
		btn_Register.setBounds(10, 500, 104, 43);
		...
		btn_login.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btn_Register.setBounds(10, 500, 104, 23);
				btn_login.setBounds(178, 500, 104, 63);
				btn_Exit.setBounds(350, 500, 104, 23);
			}
			@Override
			public void mouseExited(MouseEvent e) {
		...
		btn_Exit.addMouseListener(new MouseAdapter() {
			...
			public void mouseEntered(MouseEvent e) {	
				btn_Register.setBounds(10, 500, 104, 23);
				btn_login.setBounds(178, 500, 104, 23);
				btn_Exit.setBounds(350, 500, 104, 63);
			}
			@Override
			public void mouseExited(MouseEvent e) {
				btn_Register.setBounds(10, 500, 104, 43);
		...
		lbl_Background.setBounds(0, 0, 464, 591);
		frame.getContentPane().add(lbl_Background);
		
		ImageIcon bg = new ImageIcon("C:\\Users\\karl\\Desktop\\Vonn\\Final Project OOP\\Logo\\Facade.png");
		Image bgImg = bg.getImage();
		Image modifiedbg = bgImg.getScaledInstance(480, 630, java.awt.Image.SCALE_SMOOTH);
